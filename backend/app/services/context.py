...
def assemble_call_context(
    *,
    ...
    framework = normalize_framework(business.get("framework"))
    ...
    system_instruction = _build_system_instruction(
        business_name=business.get("name") or DEFAULT_BUSINESS_PROFILE["name"],
...
def _merge_business_context(business_profile: dict[str, Any]) -> dict[str, Any]:
    ...
    default_context = DEFAULT_BUSINESS_PROFILE["context_data"]
    return {
